...
def system():
    ...
    while True:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if (name == 'Unknown'):
                cv2.imwrite('C:/Users/Kenjales/PycharmProjects/pythonProject2/Intruder_Images/intru-{}.jpg'.format(count), im)
                flag = 1
                count += 1
                # print("df")
...
def Weapon(flag):
 if (flag == 1):
     ...
     while True:
         ...
         print(indexes)
         if indexes == 0:   flag = 2                         #print("weapon detected in frame")
...
def SMTP2():
    ...
    account_sid = 'ACab9cfe4217e6f1795ef678d2bd9da53b'
    auth_token = 'fc323ec5da7fd3e1f3b35d9d2239153a'
    client = Client(account_sid, auth_token)

    # Making a call
    call = client.calls.create(
        twiml='<Response><Say>+919158456560</Say></Response>',
        to='+919158456560',  # The recipient's phone number
        from_='+17626002811'  # Your Twilio phone number
    )
