...
url='http://192.168.90.84/cam-hi.jpg'
im=None
...
def main_screen():
    ...
    image_path = "D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/bALIMUR/abc.png"
...
def system():
    ...
    paths = glob.glob('D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/Images_Data_understanding/*')
    images = []
    image_encodings = []
    image_names = []
    count_img = 0
    ...
    while True:
        ...
        gray = np.ascontiguousarray(im[:, :, ::-1])
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if (name == 'Unknown'):
                cv2.imwrite('D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/Intruder_Images/intru-{}.jpg'.format(count), im)
                flag = 1
                count += 1
    ...
    myPath = glob.glob('D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/Intruder_Images/*')
    global countFolder
    count = 0
    for i in myPath:
        img = cv2.imread(i)
        ...
        if (count % 1 == 0 and blur > 320):
            cv2.imwrite(
                'D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/Intruder_Images/intru-{}.jpg'.format(count),img)
            count += 1
    SMTP(flag)
    print("SMTP")
...
def SMTP(flag):
 if(flag==1):
    ...
    directory = "D:/assignments/MAM/pythonProject_Aniket_EDI_final_1/pythonProject_Aniket_EDI_final_1/Intruder_Images"
    ...
    smtp_password = "gvql uqrm pkdg hqle"
